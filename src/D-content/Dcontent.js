    ...
    <div className=' rounded-xl'>
      ...
      <section className='rounded-b-xl border-b-8 grid D-contente mx-auto items-center h-[90%]'>
        <div className='flex flex-wrap bg-gradient-to-r from-gray-100 from-45% via-white via-10% to-white to-50% justify-between items-center h-[100%]'>
            <img className=' w-[44%] cursor-pointer b h-full D-content D-content1 brightness-50 hover:brightness-100 shadow drop-shadow-lg A' src={school} alt="" />
        ...
        <div className='flex flex-wrap bg-gradient-to-r from-gray-100 from-45% via-white via-10% to-white to-50% justify-between items-center h-[100%]'>
            <img className=' w-[44%] cursor-pointer b h-full D-content D-content1 brightness-50 hover:brightness-100 shadow drop-shadow-lg B' src={college} alt="" />
          <span className=' w-3/6 D-content bg-white rounded-lg '>
