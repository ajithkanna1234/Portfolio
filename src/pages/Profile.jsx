...
const Profile = () => {
    ...
    return (
        <div className="md:text-8xl text-5xl lg:text-9xl font-bold p-[4%] relative z-10 tracking-widest grid gap-4">
            ...
            <div className={`flex flex-col justify-center h-fit bg-black text-sm md:text-base md:p-8 p-4 font-light font-roboto text-justify sm:w-1/2 tracking-wide text-white z-50 relative transition-all duration-700 ${view ? "scale-100" : "scale-0"}`}>
                ...
                {/* <Image src={pikachu} alt="pikachu" className="h-10 w-fit" /> */}
            </div>
